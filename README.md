...
- **`scripts/`**: Includes scripts for RNA-seq analysis (star), msa visualization (ggmsa), principal component analysis (pca), VRN2 regional synteny analysis (syri), pan-transcriptome heatmap (tpm_heatmap).  
